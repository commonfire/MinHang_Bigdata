...
<table align="center" width="80%" border="0">
	<tr>
    	<td height="50"><div align="center" class="tableTitle">微博危险人物列表</div></td>
    </tr>
    <!-- <tr><td>
    ...
    <tr><td>
    	<table align="center" width="100%" class="datalist">
            ...
            <%
			ResultSet rs=stmt.executeQuery("select * from t_user_info where 1=1 "+cond+" and rownum<=15 order by degree asc ");
			int row=1;
			while(rs.next()){
			%>
            <tr>
                ...
                <td><div align="left">&nbsp;&nbsp;<img src="../<%=rs.getString("thumbnailurl")%>"/></div></td>
