...
public class DBOper {
	//保存函数 没有ID参数和编码
	public void save(Connection conn,HttpServletRequest request, String fieldname[], String tablename,String[] typename) throws InstantiationException, IllegalAccessException, ClassNotFoundException, UnsupportedEncodingException
	{
		save(conn,request,fieldname,tablename,typename,0,"UTF-8",false);
	}
	//保存函数 带有ID参数的
	public void save(Connection conn,HttpServletRequest request, String fieldname[], String tablename,String[] typename,int ID) throws InstantiationException, IllegalAccessException, ClassNotFoundException, UnsupportedEncodingException
	{
		save(conn,request,fieldname,tablename,typename,ID,"UTF-8",true);
	}
	//保存函数 带有ID参数和编码
	public void save(Connection conn,HttpServletRequest request, String fieldname[], String tablename,String[] typename,int ID,String encoding) throws InstantiationException, IllegalAccessException, ClassNotFoundException, UnsupportedEncodingException
	{
		save(conn,request,fieldname,tablename,typename,ID,encoding,true);
	}
	//保存函数
	public void save(Connection conn,HttpServletRequest request, String fieldname[], String tablename,String[] typename,int ID,String encoding,boolean isID) throws InstantiationException, IllegalAccessException, ClassNotFoundException, UnsupportedEncodingException
	{
		try{
	...
	//更新函数，采用默认UTF-8编码
	public void update(Connection conn,HttpServletRequest request, String fieldname[], String tablename, String[] typename, String sid, String ID) throws InstantiationException, IllegalAccessException, ClassNotFoundException, UnsupportedEncodingException
	{
		update(conn,request,fieldname,tablename,typename,sid,ID,"UTF-8");
	}
	//更新函数 2013-10-16 张培颖 优化代码   --显式释放内存
	public void update(Connection conn,HttpServletRequest request, String fieldname[], String tablename, String[] typename, String sid, String ID,String encoding) throws InstantiationException, IllegalAccessException, ClassNotFoundException, UnsupportedEncodingException
	{
		try{
			request.setCharacterEncoding(encoding);
		    int iLength = 0;
